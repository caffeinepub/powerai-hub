...
export class Backend implements backendInterface {
    ...
    async getDataInsights(): Promise<Array<DataAnalysisInsight>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDataInsights();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPersonalityResults(): Promise<Array<PersonalityQuizResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalityResults();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecommendations(): Promise<Array<DecisionToolRecommendation>> {
        if (this.processError) {
            try {
    ...
    async saveChatMessage(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async saveDataInsight(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDataInsight(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveQuizResult(arg0: Array<bigint>, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveQuizResult(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveRecommendation(arg0: Array<string>, arg1: Array<string>, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveRecommendation(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
